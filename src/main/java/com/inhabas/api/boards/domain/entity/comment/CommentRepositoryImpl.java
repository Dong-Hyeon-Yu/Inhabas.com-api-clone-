...
import com.inhabas.api.boards.domain.entity.comment.CustomCommentRepository;
import com.inhabas.api.boards.dto.comment.CommentDetailDto;
import com.querydsl.jpa.impl.JPAQueryFactory;
import lombok.RequiredArgsConstructor;
import java.util.*;

import static com.inhabas.api.boards.domain.entity.comment.QComment.comment;
