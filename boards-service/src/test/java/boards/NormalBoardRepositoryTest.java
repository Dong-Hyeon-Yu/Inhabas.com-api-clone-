...
import com.inhabas.api.menus.domain.entity.MenuGroup;
import com.inhabas.api.menus.domain.entity.MenuType;
...
public class NormalBoardRepositoryTest {
    ...
    @BeforeEach
    public void setUp() {
        Member saveMember = em.persist(MemberTest.MEMBER1);
    ...
    @Test
    public void save() {
        Member saveMember = em.find(Member.class, MemberTest.MEMBER1.getId());
    ...
    public void findAll() {
        ...
        //then
        Assertions.assertThat(boards).contains(FREE_BOARD, NOTICE_BOARD);
    ...
    public void findAllByMenuId() {
        ...
        //then
        Assertions.assertThat(freeBoards.getTotalElements()).isEqualTo(1);
        freeBoards.forEach(
                board->assertThat(board.getMenuId()).isEqualTo(freeBoardId));

        Assertions.assertThat(noticeBoards.getTotalElements()).isEqualTo(2);
