...
import com.inhabas.api.members.domain.usecase.login.questionnaire.QuestionnaireServiceImpl;
...
public class QuestionnaireServiceTest {
    ...
    public void getQuestionnaire() {
        ...
        BDDMockito.given(questionnaireRepository.findAll()).willReturn(questionnaireInDatabase);
