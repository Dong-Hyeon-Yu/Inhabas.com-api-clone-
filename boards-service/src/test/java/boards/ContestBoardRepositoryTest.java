...
public class ContestBoardRepositoryTest {
    ...
    public void settingContestBoard(){
        ...
        Member savedMember = em.persist(MemberTest.MEMBER1);
        menu = em.persist(
                Menu.builder()
    ...
    public void findAllByMenuIdTest() {
        ...
        // then
        Assertions.assertThat(returnedDtoList).usingRecursiveFieldByFieldElementComparator().isEqualTo(expectedDtoList);
    }
}
