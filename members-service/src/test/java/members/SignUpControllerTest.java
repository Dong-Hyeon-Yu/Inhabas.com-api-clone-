...
import com.inhabas.api.members.domain.usecase.MajorInfoService;
...
import com.inhabas.api.members.domain.usecase.login.questionnaire.AnswerService;
import com.inhabas.api.members.domain.usecase.login.questionnaire.QuestionnaireService;
import com.inhabas.testConfig.AuthUserServiceMockBean;
import com.inhabas.testConfig.DefaultWebMvcTest;
import members.web.SignUpController;
...
public class SignUpControllerTest {
    ...
    public void 학생_회원가입_도중_개인정보를_저장한다() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/signUp/student")
    ...
    public void 학생_개인정보를_빈칸으로_제출하면_안된다() throws Exception {
        ...
        String response = mvc.perform(MockMvcRequestBuilders.post("/signUp/student")
                        .with(SecurityMockMvcRequestPostProcessors.csrf())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonOf(signUpForm)))
    ...
    public void 임시저장했던_개인정보를_불러온다() throws Exception {
        ...
        BDDMockito.given(memberService.loadSignUpForm(12171652, "my@email.com")).willReturn(expectedSavedForm);

        //when
        String response = mvc.perform(MockMvcRequestBuilders.get("/signUp/student"))
        ...
        //then
        Assertions.assertThat(response).isEqualTo(jsonOf(expectedSavedForm));
    }
    ...
    public void 교수_회원가입_도중_개인정보를_저장한다() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/signUp/professor")
                        .with(SecurityMockMvcRequestPostProcessors.csrf())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonOf(signUpForm)))
                .andExpect(MockMvcResultMatchers.status().isNoContent())
    ...
    public void 교수_개인정보를_빈칸으로_제출하면_안된다() throws Exception {
        ...
        String response = mvc.perform(MockMvcRequestBuilders.post("/signUp/professor")
                        .with(SecurityMockMvcRequestPostProcessors.csrf())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonOf(signUpForm)))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
    ...
    public void 교수_개인정보_입력값이_정해진_범위를_초과하면_안된다() throws Exception {
        ...
        String response = mvc.perform(MockMvcRequestBuilders.post("/signUp/student")
                        ...
                        .content(jsonOf(signUpForm)))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andDo(MockMvcResultHandlers.print()) // 지울것
                .andReturn()
                .getResponse().getContentAsString(StandardCharsets.UTF_8);
    ...
    public void 회원가입에_필요한_질문들을_가져온다() throws Exception {
        ...
        BDDMockito.given(questionnaireService.getQuestionnaire()).willReturn(questionnaireInDatabase);

        //when
        String response = mvc.perform(MockMvcRequestBuilders.get("/signUp/questionnaire"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString(StandardCharsets.UTF_8);
        ...
        //then
        Assertions.assertThat(response).isEqualTo(jsonOf(questionnaireInDatabase));
    }
    ...
    public void 임시저장했던_답변을_가져온다() throws Exception {
        ...
        BDDMockito.given(answerService.getAnswers(ArgumentMatchers.anyInt())).willReturn(savedDTOs);

        //when
        String response = mvc.perform(MockMvcRequestBuilders.get("/signUp/answer"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString(StandardCharsets.UTF_8);
        ...
        //then
        Assertions.assertThat(response).isEqualTo(jsonOf(savedDTOs));
    }
    ...
    public void 회원가입을_위한_답변을_저장한다() throws Exception {
        ...
        //when then
        mvc.perform(MockMvcRequestBuilders.post("/signUp/answer")
                        .with(SecurityMockMvcRequestPostProcessors.csrf())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void 회원가입을_완료처리한다() throws Exception {
        //when
        mvc.perform(MockMvcRequestBuilders.put("/signUp/finish").with(SecurityMockMvcRequestPostProcessors.csrf()))
                .andExpect(MockMvcResultMatchers.status().isNoContent())
                .andReturn();
    }
    ...
    public void 회원가입에_필요한_전공정보를_모두_가져온다() throws Exception {
        ...
        BDDMockito.given(majorInfoService.getAllMajorInfo()).willReturn(majorInfos);

        //when
        String response = mvc.perform(MockMvcRequestBuilders.get("/signUp/majorInfo"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString(StandardCharsets.UTF_8);
        ...
        //then
        Assertions.assertThat(response).isEqualTo(jsonOf(majorInfos));
    }
    ...
    public void ID_중복_검사_중복됨() throws Exception {
        //given
        BDDMockito.given(memberService.isDuplicatedId(ArgumentMatchers.anyInt())).willReturn(true);

        //when
        mvc.perform(MockMvcRequestBuilders.get("/signUp/isDuplicated")
    ...
    public void ID_중복_검사_중복되지_않는다() throws Exception {
        //given
        BDDMockito.given(memberService.isDuplicatedId(ArgumentMatchers.anyInt())).willReturn(false);
    ...
    public void 핸드폰_중복_검사_중복된다() throws Exception {
        //given
        BDDMockito.given(memberService.isDuplicatedPhoneNumber(ArgumentMatchers.any(Phone.class))).willReturn(true);
    ...
    public void 핸드폰_중복_검사_중복되지_않는다() throws Exception {
        //given
        BDDMockito.given(memberService.isDuplicatedPhoneNumber(ArgumentMatchers.any(Phone.class))).willReturn(false);
