...
import members.domain.entity.member.type.wrapper.IbasInformation;
import members.domain.entity.member.Member;
import members.domain.entity.member.type.wrapper.SchoolInformation;
import security.domain.Role;
import members.domain.usecase.login.LoginRedirectHeaderProvider;
import members.domain.usecase.login.LoginServiceImpl;
import org.mockito.*;
import security.domain.AuthUserDetail;
import members.domain.usecase.MemberService;
