...
import com.inhabas.api.members.domain.usecase.login.questionnaire.AnswerServiceImpl;
...
public class AnswerServiceTest {
    ...
    public void saveAnswersTest() {
        ...
        BDDMockito.given(memberRepository.getById(ArgumentMatchers.anyInt())).willReturn(MemberTest.MEMBER1);
        ...
        BDDMockito.given(answerRepository.saveAll(ArgumentMatchers.any())).willReturn(expectedConvertedEntityList);
        ...
        Mockito.verify(answerRepository, Mockito.times(1)).saveAll(argumentCaptor.capture());
    ...
    public void loadAnswersTest() {
        ...
        BDDMockito.given(answerRepository.findByMember_Id(ArgumentMatchers.anyInt())).willReturn(savedAnswers);
        ...
        //then
        Assertions.assertThat(returnedDTOs)
