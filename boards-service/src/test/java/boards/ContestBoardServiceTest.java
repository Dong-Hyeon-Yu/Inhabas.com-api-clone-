...
import boards.domain.usecase.ContestBoardServiceImpl;
...
public class ContestBoardServiceTest {
    ...
    public void getContestBoardList() {
        ...
        ListContestBoardDto contestBoardDto1 = new ListContestBoardDto("title1", "contents1", LocalDate.of(2022,1,1), LocalDate.of(2022, 03, 4));
        ListContestBoardDto contestBoardDto2 = new ListContestBoardDto("title2", "contents2", LocalDate.of(2022,1,1), LocalDate.of(2022, 05, 28));
        ListContestBoardDto contestBoardDto3 = new ListContestBoardDto("title2", "contents2", LocalDate.of(2022,1,1), LocalDate.of(2022, 02, 20));
    ...
    public void updateContestBoard() {
        //given
        Member writer = new Member(12201863, "mingyeom", "010-0000-0000","picture", null, null);
        ContestBoard expectedContestBoard = new ContestBoard(1, "title", "contents", "association", "topic", LocalDate.of(2022, 1, 1), LocalDate.of(2022, 1,26) )
                .writtenBy(writer);
